      ...
      {!showWelcomeModal && (
        <>
          ...
          <a href='https://www.instagram.com/emre.bozqurt' target='_blank' rel='noopener noreferrer'
            className="absolute bottom-4 left-[50%] max-sm:bottom-2 max-sm:text-sm max-sm:w-full underline -translate-x-1/2 w-fit text-center cursor-pointer z-40 p-2 rounded-full bg-white/90 shadow-md hover:bg-white transition-colors">
