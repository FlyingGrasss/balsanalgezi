...
const locations: Location[] = [
  {
    ...
    initialCameraTarget: [-12, 0, 0], // Default camera target
  },
  {
    name: "2",
  ...
  },
  {
    ...
    hotspots: [
      ...
      { position: { x: -2.5, y: -0.1, z: -2.5 }, label: "", target: 5, type: 'animated-arrow-left' },
      { position: { x: -3, y: -0.1, z: -0.2 }, label: "", target: 10, type: 'animated-arrow-up' },
    ],
  },
  {
